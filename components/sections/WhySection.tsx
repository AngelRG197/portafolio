...
const rows = [
  { feature: 'Software 100% a medida', zyber: true, agency: false, saas: false },
  { feature: 'Sin cuotas mensuales de licencias', zyber: true, agency: false, saas: false },
  { feature: 'Código fuente entregado', zyber: true, agency: true, saas: false },
  { feature: 'ROI garantizado en contrato', zyber: true, agency: false, saas: false },
  { feature: 'Equipo técnico dedicado', zyber: true, agency: false, saas: false },
  { feature: 'Integraciones ilimitadas', zyber: true, agency: false, saas: false },
  { feature: 'Soporte 24/7 en español', zyber: true, agency: false, saas: false },
  { feature: 'Demo funcional en 72h', zyber: true, agency: false, saas: false },
]

const whyPoints = [
  'Especializados en B2B, no somos una agencia generalista.',
  'Garantizamos el precio fijado en propuesta, sin costos ocultos.',
  'Tu éxito es nuestra métrica. Cobramos parte del honorario al entregar resultados.',
  'Equipo local que habla tu idioma y entiende tu contexto de negocio.',
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-6xl font-black text-white mb-4">
            ¿Por qué <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-600">ZyberPro</span>?
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="grid grid-cols-4 bg-[#0a0a0a] border-b border-white/10">
              ...
              <div className="p-4 text-center">
                <div className="text-sm font-bold text-cyan-400">ZyberPro</div>
              </div>
              <div className="p-4 text-center">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-2xl font-bold text-white">No somos la opción más barata.<br />Somos la opción más inteligente.</h3>
            <p className="text-gray-400 leading-relaxed">
              Cualquier agencia puede entregarte código. Nosotros entregamos impacto de negocio medible.
              Cada proyecto comienza con un análisis de ROI y termina cuando los números lo confirman.
            </p>
